...
Script is in the BP360Security\Setup folder.
...
-	Open BP360Security.sln in Microsoft Visual Studio. 
-	In Solution Explorer, select the BP360Security project. 
-	Look at the BP360Security project's references. If you do not see Microsoft.ReportingServices.Interfaces.dll, then complete the following steps: 
